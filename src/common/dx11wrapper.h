...
public:
	...
	void psSetSRV(ID3D11ShaderResourceView* pSrv, uint32 numViews = 1, uint32 startSlot = 0);
	bool createSRVFromFile(const std::string& file, ID3D11ShaderResourceView *& srv, int32& width, int32& height);
