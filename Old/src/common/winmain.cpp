...
#define cus(MESSAGE) messageBoxOk(strFormat("%s\nFile: %s\nLine: %s\n Function: %s",MESSAGE,__LINE__, __FUNCTION__), "WARNING");
...
bool createGameWindow(HWND& hwnd, HINSTANCE hInstance, int nCmdShow)
{
	...
	hwnd = CreateWindowEx(NULL,	CLASS_NAME,	gameNS::WINDOW_TITLE, style, 
